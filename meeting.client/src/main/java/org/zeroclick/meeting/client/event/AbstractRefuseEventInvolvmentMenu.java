 ...
 *
 */
public abstract class AbstractRefuseEventInvolvmentMenu extends AbstractCancelMenu {
	...
	public void refresh() {
		...
		this.setVisible(eventWorkflow.canReject(this.getEventId()));
	}
	...
	protected void execAction() {
		...
		form.setEventId(this.getEventId());
